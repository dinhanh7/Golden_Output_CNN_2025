...
if __name__ == "__main__":
    ...
    input_file = "HEX_IN/op010_CONV_2D_ifm_values.hex"
    #weight_file = "hex/weight_hex_out.txt"
    weight_file = "HEX_IN/op010_CONV_2D_weight_values.hex"
    output_file = "OFM/op010_CONV_2D_ofm.hex"
    bias_file = "HEX_IN/op010_CONV_2D_bias_values.hex"
    ...
    zp_file = "HEX_IN/op010_CONV_2D_ifm_zp.hex" 
    ...
    scale_ifm = read_float_file("HEX_IN/op010_CONV_2D_ifm_scale.hex")
    scale_ofm = read_float_file("HEX_IN/op010_CONV_2D_ofm_scale.hex")
    scale_weights = read_float_array_file("HEX_IN/op010_CONV_2D_weight_scale.hex")
    zp_ofm = read_zp_file("HEX_IN/op010_CONV_2D_ofm_zp.hex")
