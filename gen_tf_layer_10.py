...
import argparse
import math
#python gen_tf_layer_10.py --ifm_height 28 --ifm_width 28 --ifm_channel 48 --weight_filter 192 --stride1 1 --padding1 0
# BIAS_FRAC_BIT = 7
...
if __name__ == "__main__":
    ...
    input_file = "HEX_IN/op018_CONV_2D_ifm_values.hex"
    #weight_file = "hex/weight_hex_out.txt"
    weight_file = "HEX_IN/op018_CONV_2D_weight_values.hex"
    output_file = "OFM/op018_CONV_2D_ofm.hex"
    bias_file = "HEX_IN/op018_CONV_2D_bias_values.hex"
    ...
    zp_file = "HEX_IN/op018_CONV_2D_ifm_zp.hex" 
    ...
    scale_ifm = read_float_file("HEX_IN/op018_CONV_2D_ifm_scale.hex")
    scale_ofm = read_float_file("HEX_IN/op018_CONV_2D_ofm_scale.hex")
    scale_weights = read_float_array_file("HEX_IN/op018_CONV_2D_weight_scale.hex")
    zp_ofm = read_zp_file("HEX_IN/op018_CONV_2D_ofm_zp.hex")
...
# ======================================================
    ...
    def init_hs_params(output_final, scale_ofm, zp_ofm):
        ...
        hs_ofm_scale_file = "HEX_IN/op019_HARD_SWISH_ofm_scale.hex"
        hs_ofm_zp_file = "HEX_IN/op019_HARD_SWISH_ofm_zp.hex"
        hs_output_file = "OFM/op019_HARD_SWISH_ofm.hex"
        try:
