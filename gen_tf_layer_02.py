...
#python gen_tf_layer_02.py --ifm_height 112 --ifm_width 112 --ifm_channel 32 --weight_filter 16 --stride1 1 --padding1 1
# BIAS_FRAC_BIT = 7
...
if __name__ == "__main__":
    ...
    weight_file = "HEX_IN/op006_CONV_2D_weight_values.hex"
    output_file = "OFM/op006_CONV_2D_ofm.hex"
    bias_file = "HEX_IN/op006_CONV_2D_bias_values.hex"
    ...
    zp_file = "HEX_IN/op006_CONV_2D_ifm_zp.hex" 
    ...
    scale_ifm = read_float_file("HEX_IN/op006_CONV_2D_ifm_scale.hex")
    scale_ofm = read_float_file("HEX_IN/op006_CONV_2D_ofm_scale.hex")
    scale_weights = read_float_array_file("HEX_IN/op006_CONV_2D_weight_scale.hex")
    zp_ofm = read_zp_file("HEX_IN/op006_CONV_2D_ofm_zp.hex")
...
# ======================================================
    ...
    def init_hs_params(output_final, scale_ofm, zp_ofm):
        ...
        hs_ofm_scale_file = "HEX_IN/op007_HARD_SWISH_ofm_scale.hex"
        hs_ofm_zp_file = "HEX_IN/op007_HARD_SWISH_ofm_zp.hex"
        hs_output_file = "OFM/op007_HARD_SWISH_ofm.hex"
        try:
